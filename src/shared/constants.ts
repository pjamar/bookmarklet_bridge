...
export const BOOKMARKLET_SETTINGS_SCHEMA_STORAGE_KEY = "bookmarklet_settings_schema";
export const BOOKMARKLET_SETTINGS_VALUES_STORAGE_KEY = "bookmarklet_settings_values";
...
export const MAX_BOOKMARKLET_SETTINGS = 20;
export const MAX_BOOKMARKLET_SETTING_LABEL_LENGTH = 80;
export const MAX_BOOKMARKLET_SETTING_DESCRIPTION_LENGTH = 500;
export const MAX_BOOKMARKLET_SETTING_TEXT_DEFAULT_LENGTH = 2000;
export const MAX_BOOKMARKLET_SETTING_OPTIONS = 20;
export const MAX_BOOKMARKLET_SETTING_OPTION_LENGTH = 80;
...
export const INTERNAL_MESSAGE_KIND = {
  ...
  SAVE_BOOKMARKLET_SETTINGS_VALUES: "save_bookmarklet_settings_values",
  CLEAR_LOGS: "clear_logs"
} as const;

export const ACTIONS = ["post", "get", "toast", "download", "downloadUrl", "copyText", "getSettings"] as const;
